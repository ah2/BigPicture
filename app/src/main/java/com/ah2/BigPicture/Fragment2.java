...
public class Fragment2 extends Fragment {
    ...
    private void search(EditText search_bar, LayoutInflater inflater, View gal) {
        ...
        if (search_bar.getText().toString().isEmpty()) {
            ...
            new LoadJsonTask(gal, inflater, true).execute("https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=175dd32e0e961580b542862dd3823e95&tags=dubai&content_type=1&has_geo=1&extras=url_c%2C+geo&per_page=30&format=json&nojsoncallback=1&auth_token=72157717168760786-5c740db89d123504&api_sig=1be65025d6fa888dc71dd146775d9c6c");
        } else {
            //Fetching data in Json from backend using Date and tags fields and adding image cards
            new LoadJsonTask(gal, inflater, true)
                    .execute("https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=175dd32e0e961580b542862dd3823e95&tags=" + search_bar.getText() + "&content_type=1&has_geo=1&extras=url_c/%2C+geo&per_page=30&format=json&nojsoncallback=1&auth_token=72157717168760786-5c740db89d123504&api_sig=1be65025d6fa888dc71dd146775d9c6c");
    ...
    public void processFinish(String output) {
        try {
            ...
            for (int i = 0; i < tagsJson.length(); i++){
                ...
                Toast.makeText(getContext(), "Tag added: " + tags.get(i), Toast.LENGTH_LONG).show();
            }
